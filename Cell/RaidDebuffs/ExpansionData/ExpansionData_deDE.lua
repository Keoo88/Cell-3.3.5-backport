...
--! WotLK fix: гейт переведён с FrameXML-глобала LOCALE_deDE на native GetLocale().
--! LOCALE_deDE объявляет не аддон, а сам клиент в Localization.lua своей локали
--! (в эталонном дампе enUS-клиента есть ровно одна такая строка, LOCALE_enUS), то есть
--! доказать существование LOCALE_deDE на deDE-клиенте 3.3.5a по эталону нельзя, а
...
Cell_ExpansionData.instanceNameAliases = {
    ...
    ["Die Hallen der Blitze"] = "Hallen der Blitze", -- Halls of Lightning
    ["Die Hallen des Steins"] = "Hallen des Steins", -- Halls of Stone
    ["Die Schmiede der Seelen"] = "Die Seelenschmiede", -- The Forge of Souls
    ["Hyjalgipfel"] = "Die Schlacht um den Hyjal", -- The Battle for Mount Hyjal
    ["Der schwarze Morast"] = "Der Schwarze Morast", -- The Black Morass
    ["Die zerschmetterten Hallen"] = "Die Zerschmetterten Hallen", -- The Shattered Halls
    ["Geschmolzener Kern"] = "Der Geschmolzene Kern", -- Molten Core
    ["Die Todesminen"] = "Todesminen", -- Deadmines
    ["Die Höhlen des Wehklagens"] = "Höhlen des Wehklagens", -- Wailing Caverns
}
